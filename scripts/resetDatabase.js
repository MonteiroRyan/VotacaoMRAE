...
async function resetDatabase() {
    ...
    try {
        ...
        const resposta = await pergunta('Digite "CONFIRMAR RESET" para continuar: ');
        ...
        const municipiosES = [
            ['Afonso Cláudio', 3.50], ['Água Doce do Norte', 2.00], ['Águia Branca', 2.50],
            ['Alegre', 4.50], ['Alfredo Chaves', 3.00], ['Alto Rio Novo', 2.00],
            ['Anchieta', 4.00], ['Apiacá', 2.00], ['Aracruz', 6.50],
            ['Atílio Vivácqua', 2.50], ['Baixo Guandu', 4.50], ['Barra de São Francisco', 5.00],
            ['Boa Esperança', 2.50], ['Bom Jesus do Norte', 2.50], ['Brejetuba', 2.00],
            ['Cachoeiro de Itapemirim', 9.00], ['Cariacica', 8.50], ['Castelo', 5.00],
            ['Colatina', 7.50], ['Conceição da Barra', 4.00], ['Conceição do Castelo', 2.50],
            ['Divino de São Lourenço', 2.00], ['Domingos Martins', 4.50], ['Dores do Rio Preto', 2.00],
            ['Ecoporanga', 3.50], ['Fundão', 4.00], ['Governador Lindenberg', 2.00],
            ['Guaçuí', 4.50], ['Guarapari', 7.50], ['Ibatiba', 3.50],
            ['Ibiraçu', 3.00], ['Ibitirama', 2.50], ['Iconha', 2.50],
            ['Irupi', 2.00], ['Itaguaçu', 2.50], ['Itapemirim', 5.00],
            ['Itarana', 2.50], ['Iúna', 4.00], ['Jaguaré', 4.00],
            ['Jerônimo Monteiro', 3.00], ['João Neiva', 3.50], ['Laranja da Terra', 2.00],
            ['Linhares', 8.00], ['Mantenópolis', 2.50], ['Marataízes', 5.50],
            ['Marechal Floriano', 2.50], ['Marilândia', 3.00], ['Mimoso do Sul', 4.00],
            ['Montanha', 3.00], ['Mucurici', 2.00], ['Muniz Freire', 3.50],
            ['Muqui', 2.50], ['Nova Venécia', 6.00], ['Pancas', 3.50],
            ['Pedro Canário', 4.00], ['Pinheiros', 4.00], ['Piúma', 3.50],
            ['Ponto Belo', 2.00], ['Presidente Kennedy', 3.00], ['Rio Bananal', 2.50],
            ['Rio Novo do Sul', 2.50], ['Santa Leopoldina', 3.00], ['Santa Maria de Jetibá', 5.00],
            ['Santa Teresa', 3.50], ['São Domingos do Norte', 2.00], ['São Gabriel da Palha', 5.00],
            ['São José do Calçado', 3.00], ['São Mateus', 7.50], ['São Roque do Canaã', 3.00],
            ['Serra', 9.50], ['Sooretama', 3.50], ['Vargem Alta', 3.00],
            ['Venda Nova do Imigrante', 3.50], ['Viana', 6.00], ['Vila Pavão', 2.00],
            ['Vila Valério', 2.50], ['Vila Velha', 9.00], ['Vitória', 10.00]
        ];
